 ...
 * @returns
 */
function formatTreeNodeBuildMenus(menus: any[]): any[] {
 ...
 * @return 结果
 */
function isMenuFrame(menu): boolean {
 ...
 * @return 结果
 */
function isInnerLink(menu): boolean {
 ...
 * @return 结果
 */
function isParentView(menu): boolean {
 ...
 * @return 组件信息
 */
function getComponent(menu): string {
 ...
 * @return 路由地址
 */
function getRouterPath(menu): string {
